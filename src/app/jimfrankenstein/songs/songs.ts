...
Cuz if there is something out there, I don't have to feel alone.`,
  ...
  // souls and ghosts
  {
    ...
    description: "The title track from the 2016 album exploring themes of mortality and the supernatural.",
    ...
    songType: "track",
    album: "Souls and Ghosts",
    albumLink: "https://open.spotify.com/album/6270AFuOn3qlgGMxIjbrQT",
    trackList: 10,
    lyrics: `[Lyrics to be added]`,
    credits: "Written and Recorded in Minneapolis by Brian Reed\nMixed & Mastered by Elise Main",
  },
  {
    id: "calamari-sunshine",
    title: "Calamari Sunshine",
    description: "A haunting exploration of underwater dreams and tentacled nightmares.",
  ...
  },
  {
    id: "azazel",
    title: "Azazel",
    description: "A dark invocation of the fallen angel and chief of the goat demons.",
  ...
  {
    id: "biotechnic-frankenstein",
    title: "Biotechnic Frankenstein",
    description: "A modern retelling of the classic monster tale through a technological lens.",
  ...
  },
  {
    id: "europa",
    title: "Europa",
    description: "A cosmic journey to Jupiter's icy moon and the mysteries beneath its surface.",
  ...
  {
    id: "cold-wind-in-the-garden",
    title: "Cold Wind in the Garden",
    description: "An atmospheric piece about death's presence in places of life and growth.",
  ...
  },
  {
    id: "weird",
    title: "Weird",
    description: "An introspective look at feeling different and embracing the strange.",
  ...
  {
    id: "ripple-in-the-tide",
    title: "Ripple in the Tide",
    description: "A meditation on small actions creating larger waves of change.",
  ...
  {
    id: "no-escape-from-the-love",
    title: "No Escape from the Love",
    description: "A haunting ballad about the inescapable nature of deep emotional connection.",
  ...
  },
  {
    id: "mr-gray",
    title: "Mr. Gray",
    description: "The opening track introducing a mysterious figure who embodies the album's themes.",
