    ...
    <main className="min-h-screen bg-[#18181b] text-white font-sans">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <h3 className="text-xl font-semibold text-center mb-6">Music & Links</h3>
          ...
          >
            <p className="text-white/80 text-center">Spooky Song | Lyric Video | Youtube</p>
          </a>
          ...
          <a
            ...
            className="block p-4 border border-white/20 rounded-lg hover:bg-white/5 transition-colors"
          >
            <p className="text-white/80 text-center">Spooky Song | Spotify</p>
          </a>
          ...
          <a
            ...
            className="block p-4 border border-white/20 rounded-lg hover:bg-white/5 transition-colors"
          >
            <p className="text-white/80 text-center">Weird (the song you liked on Resso)</p>
          </a>
          ...
          <a
            ...
            className="block p-4 border border-white/20 rounded-lg hover:bg-white/5 transition-colors"
          >
            <p className="text-white/80 text-center">Full-length Album | Souls and Ghosts</p>
          </a>
          ...
          <a
            ...
            className="block p-4 border border-white/20 rounded-lg hover:bg-white/5 transition-colors"
          >
            <p className="text-white/80 text-center">The Very Bad Days | You Call This an Apocalypse?</p>
          </a>
          ...
          <a
            ...
            className="block p-4 border border-white/20 rounded-lg hover:bg-white/5 transition-colors"
          >
            <p className="text-white/80 text-center">The Very Bad Days (my band)</p>
          </a>
        </div>
