...
export default function CardCarousel({
  ...
  }, [goToNext, goToPrevious]); // Proper dependencies

  // Calculate which cards should be visible
  const startIndex = Math.max(0, currentIndex - DISCARD_RANGE);
  const endIndex = Math.min(cards.length, currentIndex + VISIBLE_RANGE + 1);
