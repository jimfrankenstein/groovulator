      ...
      <div>
        ...
        <div className="relative bg-white dark:bg-black border-4 border-black dark:border-white p-6 shadow-2xl">
          ...
          <div className="text-center mb-6">
            <div className="text-2xl md:text-3xl font-bold text-black dark:text-white mb-2" style={{fontFamily: 'var(--font-monoton)'}}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center bg-gray-100 dark:bg-gray-800 rounded-lg p-3 border-2 border-black dark:border-white shadow-inner">
              <div className="text-3xl md:text-4xl font-bold text-black dark:text-white" style={{fontFamily: 'var(--font-monoton)'}}>
                {timeLeft.days}
              </div>
              <div className="text-xs font-semibold text-black dark:text-white tracking-wider uppercase">Days</div>
            </div>
            <div className="text-center bg-gray-100 dark:bg-gray-800 rounded-lg p-3 border-2 border-black dark:border-white shadow-inner">
              <div className="text-3xl md:text-4xl font-bold text-black dark:text-white" style={{fontFamily: 'var(--font-monoton)'}}>
                {timeLeft.hours}
              </div>
              <div className="text-xs font-semibold text-black dark:text-white tracking-wider uppercase">Hours</div>
            </div>
            <div className="text-center bg-gray-100 dark:bg-gray-800 rounded-lg p-3 border-2 border-black dark:border-white shadow-inner">
              <div className="text-3xl md:text-4xl font-bold text-black dark:text-white" style={{fontFamily: 'var(--font-monoton)'}}>
                {timeLeft.minutes}
              </div>
              <div className="text-xs font-semibold text-black dark:text-white tracking-wider uppercase">Minutes</div>
            </div>
            <div className="text-center bg-gray-100 dark:bg-gray-800 rounded-lg p-3 border-2 border-black dark:border-white shadow-inner">
              <div className="text-3xl md:text-4xl font-bold text-black dark:text-white" style={{fontFamily: 'var(--font-monoton)'}}>
                {timeLeft.seconds}
              </div>
              <div className="text-xs font-semibold text-black dark:text-white tracking-wider uppercase">Seconds</div>
            </div>
          </div>
